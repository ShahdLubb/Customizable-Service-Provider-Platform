...
import {
	...
	CustomToggle,
	CustomMenu,
} from "../../generalComponents/CustomDropdown";
...
export default function RegisterCustomer() {
	...
	const handleCompanySelect = (company) => {
		...
		formik.setFieldValue("companyName", company);
		formik.handleChange("companyName");
	};
	useEffect(() => {
		console.log("employment status changed");
				...
				<div className={`${style.registerEmailImg} col-5`}>
					...
					<div className={`${style.registerEmailImgbottom}`}>
						<div className={`${style.registerEmailImgDesc}`}>
							<h2 className="text-capitalize pb-1">register as a worker</h2>
						...
						<div className={`${style.regform}`}>
							<div className="d-flex justify-content-center gap-5">
								<div className="col-5">
									...
									<div className={` ${style.formField} d-flex flex-column`}>
										<label className="text-capitalize" htmlFor="dateOfBirth">
											Birthday
										</label>
										<DatePicker
									...
									<div className={` ${style.formField} d-flex flex-column`}>
										<label className="text-capitalize">Employment Status</label>

										<div className="d-flex justify-content-start ">
											<div className="col-7">
												<div
													className={` d-flex flex-row gap-1 align-content-center`}
												>
													<input
														type="radio"
														id="1"
													...
													/>
													<div
														className={`${style.mylabel} text-capitalize`}
														htmlFor="1"
													>
														Company Employee
													</div>
								...
								<div className="col-5">
									...
									{selectedId === 1 ? (
										<div className={` ${style.formField} d-flex flex-column`}>
											...
											<Dropdown autoClose={true} drop={"down-centered"}>
												<Dropdown.Toggle
													as={CustomToggle}
