...
//        }
        ...
        return ResponseEntity.ok("Company registered successfully - id = " + newCompany.getId());
    }
    ...
    public ResponseEntity<String> register(@Valid @RequestBody Customer customer, BindingResult bindingResult) {
        ...
        return ResponseEntity.ok("Customer registered successfully - id = " + newCustomer.getId());
    }
    ...
    public ResponseEntity<String> registerNewUser(@Valid @RequestBody EmployeeDTO employeeDTO, BindingResult bindingResult) {
        ...
        return ResponseEntity.ok("Employee registered successfully - id = " + newEmployee.getId());
    }
}
